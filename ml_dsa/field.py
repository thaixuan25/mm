...
def InfinityNorm(coeffs) -> int:
    ...
    """
    return max((abs(CenterModQ(c)) for c in coeffs), default=0)


__all__ = ["ModQ", "CenterModQ", "ModPM", "InfinityNorm"]
