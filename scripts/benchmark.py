"""Simple benchmark for keygen/sign/verify across the three ML-DSA levels.
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Number of iterations for each measurement (default: 5).",
    )
    parser.add_argument(
        "--scheme",
        choices=["44", "65", "87", "all"],
        default="all",
        help="ML-DSA level to benchmark (default: all).",
    )
